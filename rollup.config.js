...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-clipboard.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-clipboard',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-clipboard.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-clipboard.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-clipboard.esm.js',
    }),
  ],
};
